...
const CrewMessages = () => {
  ...
  const [statusEditing, setStatusEditing] = useState(false);    // inline status edit on own card
  ...
  // Inline status edit straight on your own contact card (keeps the work phone).
                                ...
                                {!cardDetail ? (
                                  ...
                                  <>
                                    ...
                                    {cardPerson.user_id === myUid ? (
                                      statusEditing ? (
                                        <input
                                          className="msg-card-status-in" autoFocus maxLength={80}
                                          value={statusDraft}
