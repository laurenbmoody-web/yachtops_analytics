...
import OrderDetailView from '../supplier-portal/views/OrderDetailView';
import CatalogueView   from '../supplier-portal/views/CatalogueView';
import DeliveriesView  from '../supplier-portal/views/DeliveriesView';
import InvoicesView    from '../supplier-portal/views/InvoicesView';
import ClientsView     from '../supplier-portal/views/ClientsView';
import MessagesView    from '../supplier-portal/views/MessagesView';
import ReturnsView     from '../supplier-portal/views/ReturnsView';
import SettingsView    from '../supplier-portal/views/SettingsView';
      ...
      <div className="sp-main">
        ...
        <div className="sp-topbar">
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 8 }}>
            <span
              className="sp-badge"
              style={{ background: '#1E3A5F', color: '#FDE68A', letterSpacing: '1px' }}
              title="This is a non-live showcase of the supplier portal. No real data."
            >DEMO</span>
...
export default SupplierPortalDemo;
