  ...
  useEffect(() => {
    if (vesselData && !formInitialized) {
      ...
      const initialFormData = {
        ...
        billing_legal_name: vesselData?.billing_legal_name || '',
        billing_address: vesselData?.billing_address || '',
        billing_vat_number: vesselData?.billing_vat_number || '',
        billing_reg_number: vesselData?.billing_reg_number || '',
        billing_email: vesselData?.billing_email || '',
