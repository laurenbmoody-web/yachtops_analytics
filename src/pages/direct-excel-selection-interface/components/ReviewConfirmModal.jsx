...
const ReviewConfirmModal = ({ data, onConfirm, onAdjust, onClose }) => {
  ...
  return (
    <ModalShell onClose={onClose} panelClassName="bg-card border border-border rounded-2xl shadow-xl max-w-3xl w-full mx-4 max-h-[90vh] overflow-hidden flex flex-col">
      {/* Header */}
