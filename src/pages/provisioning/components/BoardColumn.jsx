...
const BoardColumn = ({
  ...
  return (
    <div
      className="flex flex-col w-[280px] min-w-[280px] flex-shrink-0 bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.07)] rounded-xl"
    ...
    >
      ...
      {/* Items — scrollable, takes remaining space */}
      <div className="flex-1 overflow-y-auto px-2 space-y-2 py-1 min-h-0">
        ...
        {/* Hidden count inside scroll so it doesn't push quick-add */}
        {hiddenCount > 0 && (
      ...
      {/* Quick-add — always visible, outside scroll area */}
