...
const DefectDetailModal = ({ defect, currentUser, teamMembers, onClose, onDefectUpdated }) => {
  ...
  return (
    <ModalShell onClose={onClose} panelClassName="bg-card border border-border rounded-2xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
      ...
      {/* Status Change Modal */}
      {showStatusModal && (
        <ModalShell onClose={() => setShowStatusModal(false)} panelClassName="bg-card border border-border rounded-2xl p-6 max-w-md w-full mx-4">
      ...
      {/* Assign Modal */}
      {showAssignModal && (
        <ModalShell onClose={() => setShowAssignModal(false)} panelClassName="bg-card border border-border rounded-2xl p-6 max-w-md w-full mx-4">
