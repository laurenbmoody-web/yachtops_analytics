...
export const SEATIME_REVIEW_QUEUE = [
  ...
  },
  {
    ...
    unit: {
      ...
      periods: [
        { id: 'e6', dateMain: '03 – 10 Apr', days: 8, type: 'standby', watchHours: 0, capacity: 'Chief Officer', detailOverride: 'Subject to regulatory cap', from: '2026-04-03', to: '2026-04-10' },
