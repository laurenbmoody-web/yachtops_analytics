// Dependency-free synchronous SHA-256 (hex). Identical output in Node (tests)
// and the browser (no Web Crypto async plumbing through the renderer). Standard
...
/**
 * @param {string} ascii  UTF-8 string to hash
