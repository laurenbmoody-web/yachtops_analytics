...
import VesselDocuments from './pages/vessel-documents';
...
import LibMocks from './pages/vessel-map/LibMocks';
  ...
  return (
    <BrowserRouter>
      ...
      <RouterRoutes>
        ...
        {/* TEMP: scan-library design exploration — remove once a direction ships */}
        <Route path="/vessel/map/manage/lib-mocks" element={<ProtectedRoute requiredRoles={['COMMAND', 'CHIEF']}><LibMocks /></ProtectedRoute>} />
