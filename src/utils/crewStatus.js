...
const STATUS_CONFIG = {
  ...
  rotational_leave: { label: 'On Rotational Leave', dot: 'bg-amber-500',  badge: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400',   cell: 'bg-amber-200 dark:bg-amber-800' },
