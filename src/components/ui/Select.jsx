    ...
    return (
        <div className={cn("relative", className)}>
            ...
            <div className="relative">
                ...
                {/* Dropdown - HIGH CONTRAST DARK THEME */}
                {isOpen && (
                    <div className="absolute z-50 w-full mt-1 bg-card border border-border rounded-md shadow-lg">
                            ...
                            <div className="p-2 border-b border-border bg-card">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 pl-8 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
                                        style={{
                        ...
                        <div className="py-1 max-h-60 overflow-auto bg-card">
