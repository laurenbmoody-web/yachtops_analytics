      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="md:col-span-1">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginTop: 16 }}>
            <a href="https://www.instagram.com/cargo_technologyltd" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: '#64748B', lineHeight: 0 }}>
            ...
            <a href="https://www.facebook.com/share/18UE33fLNg/?mibextid=LQQJ4d" target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={{ color: '#64748B', lineHeight: 0 }}>
