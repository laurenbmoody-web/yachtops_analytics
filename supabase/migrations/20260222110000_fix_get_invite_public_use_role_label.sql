-- Migration: Fix get_invite_public to read from role_label and department_label
-- Purpose: Update function to prioritize new schema columns (role_label, department_label) over legacy columns
-- Date: 2026-02-22

-- Drop existing function
DROP FUNCTION IF EXISTS public.get_invite_public(TEXT);

-- Create updated RPC function to get public invite details with correct column priority
